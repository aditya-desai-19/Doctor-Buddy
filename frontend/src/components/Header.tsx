  ...
  return (
    <nav className="w-full px-6 py-4 shadow-md" >
      <div className="flex justify-between items-center mx-20">
        ...
        ) : <Button className="bg-white border-2 border-gray-200 text-gray-500 hover:text-blue-500 hover:border-blue-400 hover:bg-white" onClick={() => router.push("/login")}>{`${t("Login")} / ${t("Signup")}`}</Button>}
      </div>
    </nav>
  )
}
